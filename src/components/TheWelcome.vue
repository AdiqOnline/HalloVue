...
import IconAvanza from './icons/IconAvanza.vue';
import IconAlpart from './icons/IconAlpart.vue';
import IconFortuner from './icons/IconFortuner.vue';
import IconToyota from './icons/IconToyota.vue';
import IconAgya from './icons/IconAgya.vue';
import IconLegian from './icons/IconLegian.vue';
import IconMenjangan from './icons/IconMenjangan.vue';
import IconNusa from './icons/IconNusa.vue';
import IconNusabarat from './icons/IconNusabarat.vue';
import IconNusadua from './icons/IconNusadua.vue';
import IconSanur from './icons/IconSanur.vue';
import IconUbud from './icons/IconUbud.vue';
import IconInnova from './icons/IconInnova.vue';
  ...
  <div class="body">
    <div id="root">
      <WelcomeItem nama="Paket Tour Nusa Penida - Sisi Timur + Snorkeling" harga="975.000" >
        ...
        <a href="http://hallobali.id/id/share/26532/paket-tour-nusa-penida-sisi-timur-snorkeling">Detail</a>
      </WelcomeItem>
      <WelcomeItem nama="Paket Tour Nusa Penida - Sisi Barat + Snorkeling" harga="975.000">
        <template #images>
          <IconNusabarat></IconNusabarat>
        </template>
        <a href="http://hallobali.id/id/share/26533/paket-tour-nusa-penida-sisi-barat-snorkeling">Detail</a>
      </WelcomeItem>
      <WelcomeItem nama="Paket Menginap di Menjangan - 4 Hari 3 Malam" harga="3.700.000">
        <template #images>
          <IconMenjangan></IconMenjangan>
        </template>
        <a href="http://hallobali.id/id/share/26538/paket-menginap-di-menjangan-4-hari-3-malam">Detail</a>
      </WelcomeItem>
      <WelcomeItem nama="Paket Menginap di Legian - 4 Hari 3 Malam" harga="1.600.000">
        <template #images>
          <IconLegian></IconLegian>
        </template>
